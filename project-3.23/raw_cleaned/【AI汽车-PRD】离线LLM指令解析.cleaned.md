...
| 领域 | 一级功能 | 二级功能 |
|---|---|---|
| 空调 | 空调开关 空调温度调节 空调风量调节 |  |
| 座椅 | 座椅按摩/通风/加热开关 座椅按摩/通风/加热档位调节 |  |
| 灯光 | 阅读灯/氛围灯开关 氛围灯颜色调节（基础颜色） 危险警报灯开关 远近光灯开关 雾灯开关 |  |
| 车窗控制 | 车窗开关 后备箱开关 |  |
| 雨刮 | 雨刮开关 雨刮档位调节 玻璃清洗 |  |
| 方向盘 | 方向盘加热开关 方向盘加热档位调节 |  |
| 驾驶模式 | 驾驶模式设置 |  |
| 倒车影像 | 倒车影像开关 |  |
| 声音调节 | 音量大小调节（媒体/导航/语音/电话） 低速行人提示音开关 |  |
| 屏幕亮度调节 | 屏幕亮度调节 屏幕显示模式调节（白天/黑夜） |  |
| 目的地设置 | 导航去具体地点 |  |
| 路线规划 | 选择第几条路线 |  |
| 途经点添加 | 添加具体地点为途经点 |  |
| 地图控制 | 放大/缩小地图 开始/结束导航 |  |
| 导航设置 | 播报模式设置 路线偏好设置 路况开关 限行开关 |  |
| 本地音乐播放 | 播放U盘/蓝牙音乐 |  |
| 媒体源切换 | 暂停/播放/上一首/下一首 播放模式设置 |  |
| 本地通讯录拨号 | 拨打具体联系人的电话 拨打具体号码的电话 |  |
| 紧急电话播放 | 拨打道路救援电话 拨打紧急救援电话 |  |
| 应用控制 | 应用开关 | 打开/关闭应用（如：打开百度地图） |
