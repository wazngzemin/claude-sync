...
metadata: 
  ...
  modified: 2026-07-27T06:27:27.023Z
---
...
8. **行业+产品应用层(2026-07-27 定死,不可省)** —— 他反馈"针对我的行业以及我的产品上的内容补充还是有些少"后确立:每篇必须有专门大节落到①行业对照(用他的行业坐标逐项打分/穷举,表格)②产品施工图(概念逐件映射到他的真实模块:{{memory}}/operate_user_memory/face_id/advisor/触发器/动态示例V2/A-F badcase分诊等,每件=现有实体+已干活case+缺口+下一步动作),收尾带本周/本月/本季度行动清单(产物名+照说台词,参照7.20 v4风格)。抽象映射("这对应你的记忆模块")不算应用,要有真实信号名、真实case、可执行动作。
